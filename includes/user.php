 ...
 */
 class user
 {
 	...
 	//tell whether user is already registered or not
 	...
 	public function userLogin($email,$password){
        ...
        //$user = new User();
         //echo $user->createUserAccount("Yvonne","gatugi@gmail.com","54321","Admin");

        // echo $user->userLogin("kvynmutwiri@gmail.com","12345");
